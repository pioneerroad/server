module.exports = function(models) {
    ...
    models.sequelize.query('ALTER TABLE "user_profiles" ADD COLUMN "lastCheckinCoordinates" GEOMETRY(point)');
    models.sequelize.query('ALTER TABLE "dataStore_location" ADD COLUMN the_geom GEOMETRY(point)');
